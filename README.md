...
- [00 - Introduction](doc/DOCUMENTATION%20TECHNIQUE/00_INTRODUCTION.md) - Presentation du projet, equipe, technologies
- [01 - Architecture](doc/DOCUMENTATION%20TECHNIQUE/01_ARCHITECTURE.md) - Schema d'architecture, composants, securite
...
- [Manuel utilisateur complet (avec captures)](doc/MANUEL%20UTILISATEUR/README.md) - Guide utilisateur illustre (web + mobile)
...
| Connexion OAuth2 Google                | V   | V      | Passport.js, création compte auto             |
| Connexion OAuth2 GitHub                | V   | V      | Passport.js, création compte auto             |
...
| Téléchargement dossier complet en ZIP         | V   | V      | généré à la volée côté serveur   |
...
| Invitation par email                      | V   | V      | nodemailer                                    |
...
| Graphique répartition par type (PieChart) | V   | V      | Recharts                        |
