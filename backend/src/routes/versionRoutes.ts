...
router.post('/files/:fileId/versions/:versionId/restore', requireDelegationPermission('write'), verifyDirectSharePassword, VersionController.restoreVersion);

// DELETE /api/files/:fileId/versions/:versionId - Supprimer une version
router.delete('/files/:fileId/versions/:versionId', requireDelegationPermission('delete'), verifyDirectSharePassword, VersionController.deleteVersion);
