      ...
      default:
          ...
          if (isPasswordProtectedSharedFile) {
            return (
              <div className="flex flex-col items-center justify-center p-12 bg-gray-100 dark:bg-gray-900 rounded-lg text-center">
                ...
                <p className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('files.preview_office_unavailable')}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">{t('files.preview_office_protected_desc')}</p>
        ...
        return (
          <div className="flex flex-col items-center justify-center p-12 bg-gray-100 dark:bg-gray-900 rounded-lg">
            ...
            <p className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('files.preview_unavailable')}</p>
