  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <FilePreviewModal
        ...
        getDownloadUrl={previewIsShared ? fileService.getSharedDownloadUrl : undefined}
      ...
      >
        <View style={styles.folderModal}>
          ...
          <FilePreviewModal
            ...
            getStreamUrl={fileService.getSharedStreamUrl}
            getDownloadUrl={fileService.getSharedDownloadUrl}
            readOnly={true}
          />
        </View>
      </Modal>}
