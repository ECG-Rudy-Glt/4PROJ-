...
const makeStyles = (c: AppColors) => StyleSheet.create({
  ...
  backText: { ...typography.bodySmall, color: c.neutral[500] },
  successBox: { alignItems: 'center', gap: spacing.md, paddingVertical: spacing.lg },
  successIcon: { marginBottom: spacing.sm },
  successTitle: { ...typography.h4, color: c.success },
  successMsg: { ...typography.bodySmall, color: c.neutral[600], textAlign: 'center' },
});
